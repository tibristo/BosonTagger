...
python mva_tools.py --algorithm=AntiKt10LCTopoTrimmedPtFrac5SmallR20_13tev_mc15_v1_200_1000_mw --plotCorrMatrix --fileid=full_allvars_mc15 --key=mc15_v1_2_10_v6 --createFoldsOnly --folds=1 --runTestCase=True --allVars
...
python mva_tools.py --algorithm=AntiKt10LCTopoTrimmedPtFrac5SmallR20_13tev_mc15_notcleaned_v1_200_1000_mw --key=mc15_nc_v1_2_10_v1 --createFoldsOnly --onlyFull

# create the folds for the CLEANED sample (set the fulldataset to that obtained above
python mva_tools.py --algorithm=AntiKt10LCTopoTrimmedPtFrac5SmallR20_13tev_mc15_v1_200_1000_mw --key=mc15_v1_2_10 --createFoldsOnly --fulldataset=persist/data_mc15_nc_v1_2_10_v1_100.pkl
...
startcluster8
python mva_tools.py --algorithm=AntiKt10LCTopoTrimmedPtFrac5SmallR20_13tev_mc15_v1_200_1000_mw --key=mc15_v1_2_10 --fulldataset=persist/data_mc15_nc_v1_2_10_v1_100.pkl --runMVA=True --weight-validation # --transform-weights --tranform-valid-weights 

# can now get some info out of the cv splits if we want
python mva_tools.py --algorithm=AntiKt10LCTopoTrimmedPtFrac5SmallR20_13tev_mc15_v1_200_1000_mw --key=mc15_v1_2_10 --fulldataset=persist/data_mc15_nc_v1_2_10_v1_100.pkl --plotCV
