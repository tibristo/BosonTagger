...
idx_part2 +='/index.html">Study Home</a>\n<hr>\n<font size="3">\n'

#idx_part2 += '<TABLE>\n<TR>\n<a href="events.txt"><H3><font color="#0000FF"> events.txt </font></H3></a>\n<a href="jet2Flavors.txt"><H3><font color="#0000FF"> jet2Flavors.txt </font></H3></a>\n<a href="scales.txt"><H3><font color="#0000FF"> scales.txt </font></H3></a>\n</TR>\n</TABLE>\n'
